    ...
    <div style={{ 
      ...
      <div style={{ zIndex: 10, width: '100%', maxWidth: '400px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
            ...
            <h1 style={{ color: 'white', fontSize: '32px', fontWeight: '900', marginTop: '5px' }}>Sistem Presensi</h1>
          ...
          {!user ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <button onClick={handleLogin} style={{ 
                width: '100%', padding: '18px', background: 'white', color: '#0a101e', 
            ...
            <div>
              ...
              <button onClick={handleHadir} disabled={loading} style={{ 
                ...
                color: 'white', border: 'none', borderRadius: '18px', fontSize: '15px', fontWeight: '900', cursor: 'pointer'
              }}>
